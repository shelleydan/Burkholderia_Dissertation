...
<br>
#### This repository supports the analysis which contributes to a dissertation submission for BIT104 of MSc Big Data Biology at Cardiff University. This dissertation is titled: A comparative genomic interrogation of _Burkholderia cenocepacia_ as a cystic fibrosis lung pathogen  and rarely encountered environmental bacterium. 

# Abstract

Burkholderia cenocepacia is an opportunistic pathogen within the Burkholderia cepacia complex (Bcc) and is a severe risk for people with cystic fibrosis (CF). Lately, the identification of a novel species, B. orbicola with close genomic boundaries with B. cenocepacia raises concerns of the integrity of public genomic repositories and previous studies comparing environmentally and clinically derived isolates. In this study, we reconstructed a comprehensive genome collection by applying stringent quality control and taxonomic assignment through average nucleotide identity (ANI). Of the high-quality genomes (n=748), we identified that over one-third (37.6%) were misclassified, with B. orbicola (32.8%; n=246) being frequently mislabelled as B. cenocepacia. With focus on true B. cenocepacia (n=467), we investigated population biology and performed a genome-wide association study to identify distinct genomic regions associated with environmental and CF sourced isolates. We identified a ~5000bp region of chromosome 2 associated with CF-derived isolates with the potential to enhance bacterium adaption to the CF-lung environment. Sequence types identified within the collection represented epidemic lineages, with some, ST33 and ST210 enriched in metal resistance genes which may suggest environmental origins. This study advances our understanding of B. cenocepacia by highlighting misclassification of the database and uncovering genomic traits potentially underlying the success as an environmental bacterium and high-risk CF pathogen. 
